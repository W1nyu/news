...
function renderHeadlines(){
  ...
  $('headlines').innerHTML=top.map(({a,i})=>`<button type="button" data-index="${i}"><span class="badge">${esc(a.topic)}</span><em>${highlight(a.title,a.keyword_matches)}</em></button>`).join('');
}
